...
module.exports.employeeToOih = (msg) => {
  ...
  const expression = {
    meta: {
      ...
      applicationUid:
        msg.meta.applicationUid !== undefined &&
        msg.meta.applicationUid !== null
          ? msg.meta.applicationUid
          : 'appUid not set yet',
      iamToken:
        msg.meta.iamToken !== undefined && msg.meta.iamToken !== null
          ? msg.meta.iamToken
          : undefined,
      domainId:
        msg.meta.domainId !== undefined && msg.meta.domainId !== null
          ? msg.meta.domainId
          : undefined,
      schema:
        msg.meta.schema !== undefined && msg.meta.schema !== null
          ? msg.meta.schema
          : undefined,
    },
    data: {
      firstName: msg.body.data.attributes.first_name.value,
      lastName: msg.body.data.attributes.last_name.value,
      email: msg.body.data.attributes.email.value,
  ...
  Object.keys(expression.data).forEach(
    (key) =>
      (expression.data[key] == null || expression.data[key] === undefined) &&
