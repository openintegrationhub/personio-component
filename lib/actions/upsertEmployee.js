...
async function processAction(msg, cfg) {
  ...
  const oihUid = transformedMessage.meta
    ? transformedMessage.meta.oihUid
    : "oihUid not set yet";
  let recordUid = transformedMessage.meta
    ? transformedMessage.meta.recordUid
    : null;
  const applicationUid = transformedMessage.meta
    ? transformedMessage.meta.applicationUid
    : null;
  ...
  async function emitData() {
    ...
    let employeeObject = transformedMessage.data;
